        ...
        <div class="d-flex flex-column justify-content-center text-center inner-wrapper">
            ...
            <div class="login">
                <form class="login-form">
                    <input class="login-input" type="text" :placeholder="(getBool(register) ? 'Придумайте л' : 'Л') + 'огин'"/><br>
                    <input class="login-input" type="password" :placeholder="(getBool(register) ? 'Придумайте п' : 'П') + 'ароль'"/><br>
                    <input v-if="getBool(register)" class="login-input" type="password" placeholder="Повторите пароль"/><br>
